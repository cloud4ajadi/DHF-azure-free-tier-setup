# DHF-azure-free-tier-setup-project
...
A Virtual Machine was successfully deployed using the Azure Portal.
...
* Public IP address: 20.164.17.224
* Virtual network/subnet: test-vm-vnet/default
* Location: South Africa North (Zone 1)
* Source image offer: ubuntu-24_04-lts

Deploying a virtual machine demonstrates one of Azure's core infrastructure services.

**Figure 5:** Virtual Machine Deployment
